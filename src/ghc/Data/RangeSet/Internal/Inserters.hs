...
insertLAdj :: E -> E -> Int -> E -> E -> RangeSet a -> RangeSet a -> RangeSet a
insertLAdj !l !u !th !tl !tu !tlt !trt = case minRange tl tu tlt of
  ...
  where
    {-# INLINEABLE fuseL #-}
    fuseL :: E -> Int -> E -> E -> RangeSet a -> RangeSet a -> RangeSet a
...
insertRAdj :: E -> E -> Int -> E -> E -> RangeSet a -> RangeSet a -> RangeSet a
insertRAdj !l !u !th !tl !tu !tlt !trt = case maxRange tl tu trt of
  ...
  where
    {-# INLINEABLE fuseR #-}
    fuseR :: E -> Int -> E -> E -> RangeSet a -> RangeSet a -> RangeSet a
